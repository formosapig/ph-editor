...
def serialize_face_data(face_data: dict, stream: BytesIO):
    ...
    try:
        ...
        if "eyebrows" in face_data:
            ...
            stream.write(
                _pack_color(eyebrows.get("!shine", (205, 205, 205, 255)))
            )  # Assuming default for !shine_color
        ...
        if "eyeballs" in face_data and "left_eyeball" in face_data["eyeballs"]:
            ...
            stream.write(
                _pack_color(left_eyeball.get("sclera_color", (255, 255, 255, 255)))
            )
        ...
        if "eyeballs" in face_data and "right_eyeball" in face_data["eyeballs"]:
            ...
            stream.write(
                _pack_color(right_eyeball.get("sclera_color", (255, 255, 255, 255)))
            )
            ...
            stream.write(
                _parse_and_pack_float(right_eyeball.get("pupil_brightness", 0))
            )
        ...
        if "tattoo" in face_data:
            ...
            stream.write(
                _pack_hex_to_bytes(tattoo.get("!padding", "43 00 00 00"), 4)
            )  # Assuming padding is hex string
        ...
        if "eyelashes" in face_data:
            ...
            stream.write(
                _pack_color(eyelashes.get("!shine", (185, 188, 177, 255)))
            )  # Assuming default for !shine_color
        ...
        if "eyeballs" in face_data:
            ...
            stream.write(
                _pack_color(eyeballs.get("highlight_color", (255, 255, 255, 255)))
            )
            stream.write(
                _pack_color(eyeballs.get("!highlight_shine", (255, 255, 255, 255)))
            )  # Assuming default for !highlight_shine
