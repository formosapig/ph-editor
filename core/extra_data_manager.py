...
# gen = generation
ORDER_BACKSTAGE = ["tag", "!tag_id", "persona", "!persona_code", "shadow", "!shadow_code", "!resonance_id", "resonance", "title", "detail", "notes", "cup"] + ORDER_DEFAULT
...
class ExtraDataManager():
    ...
    def remove_metadata(self, sn: str):
        if sn in self._metadata_map:
            ...
            self._save_metadata_data()
            logger.info(f"metadata {sn} removed.")
